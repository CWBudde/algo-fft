...
- [ ] `internal/kernels/codelet_init_avx2.go`: re-enable `dit8_radix4_avx2` by fixing roundtrip failures (likely inverse/twiddle usage or bitrev expectations; note mixed-radix bitrev is `[0,2,4,6,1,3,5,7]`).
