...
func TestSSE2SizeSpecificComplex64(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name:          "Size8_Radix4",
			size:          8,
			forward:       forwardSSE3Size8Radix4Complex64Asm,
			inverse:       inverseSSE3Size8Radix4Complex64Asm,
			testRoundTrip: true,
			testInPlace:   true,
		},
		{
			name:          "Size256_Radix4",
			size:          256,
			forward:       forwardSSE3Size256Radix4Complex64Asm,
			inverse:       inverseSSE3Size256Radix4Complex64Asm,
			testRoundTrip: true,
			testInPlace:   true,
		},
		{
			name:          "Size512_Radix2",
			size:          512,
			forward:       forwardSSE3Size512Radix2Complex64Asm,
			inverse:       inverseSSE3Size512Radix2Complex64Asm,
			testRoundTrip: true,
			testInPlace:   true,
		},
		{
			name:          "Size512_Radix4Then2",
			size:          512,
			forward:       forwardSSE3Size512Radix4Then2Complex64Asm,
			inverse:       inverseSSE3Size512Radix4Then2Complex64Asm,
			testRoundTrip: true,
			testInPlace:   true,
		},
		{
			name:          "Size1024_Radix4",
			size:          1024,
			forward:       forwardSSE3Size1024Radix4Complex64Asm,
			inverse:       inverseSSE3Size1024Radix4Complex64Asm,
			testRoundTrip: true,
			testInPlace:   true,
		},
	}
