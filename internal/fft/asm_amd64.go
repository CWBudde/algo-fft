...
func forwardAVX2Size512Mixed24Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.ForwardAVX2Size512Mixed24Complex64Asm(dst, src, twiddle, scratch, bitrev)
}

func forwardAVX2Size2048Mixed24Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.ForwardAVX2Size2048Mixed24Complex64Asm(dst, src, twiddle, scratch, bitrev)
}

func forwardAVX2Size8192Mixed24Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.ForwardAVX2Size8192Mixed24Complex64Asm(dst, src, twiddle, scratch, bitrev)
}
...
func inverseAVX2Size2048Mixed24Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.InverseAVX2Size2048Mixed24Complex64Asm(dst, src, twiddle, scratch, bitrev)
}

func inverseAVX2Size8192Mixed24Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.InverseAVX2Size8192Mixed24Complex64Asm(dst, src, twiddle, scratch, bitrev)
}
...
func forwardAVX2Size512Radix2Complex128Asm(dst, src, twiddle, scratch []complex128, bitrev []int) bool {
	return kasm.ForwardAVX2Size512Radix2Complex128Asm(dst, src, twiddle, scratch, bitrev)
}

func inverseAVX2Size512Radix2Complex128Asm(dst, src, twiddle, scratch []complex128, bitrev []int) bool {
	return kasm.InverseAVX2Size512Radix2Complex128Asm(dst, src, twiddle, scratch, bitrev)
}
...
func forwardAVX2Size64Radix2Complex128Asm(dst, src, twiddle, scratch []complex128, bitrev []int) bool {
	return kasm.ForwardAVX2Size64Radix2Complex128Asm(dst, src, twiddle, scratch, bitrev)
}

func inverseAVX2Size64Radix2Complex128Asm(dst, src, twiddle, scratch []complex128, bitrev []int) bool {
	return kasm.InverseAVX2Size64Radix2Complex128Asm(dst, src, twiddle, scratch, bitrev)
}
...
func forwardSSE2Size8Radix8Complex128Asm(dst, src, twiddle, scratch []complex128, bitrev []int) bool {
	return kasm.ForwardSSE2Size8Radix8Complex128Asm(dst, src, twiddle, scratch, bitrev)
}

func inverseSSE2Size8Radix8Complex128Asm(dst, src, twiddle, scratch []complex128, bitrev []int) bool {
	return kasm.InverseSSE2Size8Radix8Complex128Asm(dst, src, twiddle, scratch, bitrev)
}

func forwardSSE2Size8Radix4Complex128Asm(dst, src, twiddle, scratch []complex128, bitrev []int) bool {
	return kasm.ForwardSSE2Size8Radix4Complex128Asm(dst, src, twiddle, scratch, bitrev)
}

func inverseSSE2Size8Radix4Complex128Asm(dst, src, twiddle, scratch []complex128, bitrev []int) bool {
	return kasm.InverseSSE2Size8Radix4Complex128Asm(dst, src, twiddle, scratch, bitrev)
}

func forwardSSE2Size16Radix2Complex128Asm(dst, src, twiddle, scratch []complex128, bitrev []int) bool {
	return kasm.ForwardSSE2Size16Radix2Complex128Asm(dst, src, twiddle, scratch, bitrev)
}

func inverseSSE2Size16Radix2Complex128Asm(dst, src, twiddle, scratch []complex128, bitrev []int) bool {
	return kasm.InverseSSE2Size16Radix2Complex128Asm(dst, src, twiddle, scratch, bitrev)
}
...
func forwardSSE2Size64Radix2Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.ForwardSSE2Size64Radix2Complex64Asm(dst, src, twiddle, scratch, bitrev)
}

func inverseSSE2Size64Radix2Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.InverseSSE2Size64Radix2Complex64Asm(dst, src, twiddle, scratch, bitrev)
}

func forwardSSE2Size128Mixed24Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.ForwardSSE2Size128Mixed24Complex64Asm(dst, src, twiddle, scratch, bitrev)
}

func inverseSSE2Size128Mixed24Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.InverseSSE2Size128Mixed24Complex64Asm(dst, src, twiddle, scratch, bitrev)
}

func forwardSSE2Size128Radix2Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.ForwardSSE2Size128Radix2Complex64Asm(dst, src, twiddle, scratch, bitrev)
}

func inverseSSE2Size128Radix2Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.InverseSSE2Size128Radix2Complex64Asm(dst, src, twiddle, scratch, bitrev)
}

func forwardSSE2Size256Radix4Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.ForwardSSE2Size256Radix4Complex64Asm(dst, src, twiddle, scratch, bitrev)
}

func inverseSSE2Size256Radix4Complex64Asm(dst, src, twiddle, scratch []complex64, bitrev []int) bool {
	return kasm.InverseSSE2Size256Radix4Complex64Asm(dst, src, twiddle, scratch, bitrev)
}
