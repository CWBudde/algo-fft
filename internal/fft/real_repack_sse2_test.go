...
func TestInverseRepackComplex64SSE2(t *testing.T) {
	...
	for _, half := range cases {
		t.Run("HalfSize_"+itoaRepack(half), func(t *testing.T) {
			runInverseRepackSSE2Case(t, half, func(k int) complex64 {
				n := half * 2
...
func TestInverseRepackComplex64SSE2_ZeroWeight(t *testing.T) {
	half := 16
	runInverseRepackSSE2Case(t, half, func(int) complex64 { return 0 })
}

func TestInverseRepackComplex64SSE2_PureRealWeight(t *testing.T) {
	runInverseRepackSSE2Case(t, 16, func(int) complex64 { return complex(0.25, 0) })
}

func TestInverseRepackComplex64SSE2_PureImagWeight(t *testing.T) {
	runInverseRepackSSE2Case(t, 16, func(int) complex64 { return complex(0, 0.25) })
}

func runInverseRepackSSE2Case(t *testing.T, half int, weightFn func(k int) complex64) {
	t.Helper()
	...
	limit := half / 2
	if limit >= 1 {
		amd64.InverseRepackComplex64SSE2Asm(dstSIMD, src, weight, limit)
	}
