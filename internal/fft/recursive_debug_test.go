...
func TestRecursiveDebug_Size1024_Combine(t *testing.T) {
	...
	if err := compareComplexSlices(recursiveOutput, output, 1e-6); err != nil {
...
func TestRecursiveDebug_InverseSize512(t *testing.T) {
	...
	if err := compareComplexSlices(inverse, input, 1e-3); err != nil {
	...
	if err := compareComplexSlices(inverseCodelet, input, 1e-3); err != nil {
