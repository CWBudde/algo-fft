...
TEXT ·ForwardSSE2Size16Radix4Complex128Asm(SB), NOSPLIT, $64-61
	// Load parameters
	MOVL dst+0(FP), AX
	MOVL src+12(FP), CX
...
bitrev_loop:
	...
	MOVL 0(SP), DI
	XORL SI, SI
	// Masks loaded on demand to avoid stack spills.
...
TEXT ·InverseSSE2Size16Radix4Complex128Asm(SB), NOSPLIT, $64-61
	MOVL dst+0(FP), AX
	MOVL src+12(FP), CX
	MOVL src_len+16(FP), DX
	CMPL DX, $16
