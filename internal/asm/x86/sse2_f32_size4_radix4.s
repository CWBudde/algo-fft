...
// ===========================================================================
TEXT ·ForwardSSE2Size4Radix4Complex64Asm(SB), NOSPLIT, $0-61
	// Load parameters
	...
	MOVL twiddle_len+28(FP), DX
	CMPL DX, $4
	JL   size4_sse2_32_fwd_return_false

	MOVL scratch_len+40(FP), DX
	CMPL DX, $4
	JL   size4_sse2_32_fwd_return_false
...
// ===========================================================================
TEXT ·InverseSSE2Size4Radix4Complex64Asm(SB), NOSPLIT, $0-61
	// Load parameters
	MOVL dst+0(FP), AX
	MOVL src+12(FP), CX
