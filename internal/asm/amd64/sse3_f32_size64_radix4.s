...
TEXT ·ForwardSSE3Size64Radix4Complex64Asm(SB), NOSPLIT, $0-97
	// Load parameters
	...
	MOVQ src_len+32(FP), R13     // R13 = n (should be 64)
...
TEXT ·InverseSSE3Size64Radix4Complex64Asm(SB), NOSPLIT, $0-97
	// Load parameters
	MOVQ dst+0(FP), R8
	MOVQ src+24(FP), R9
