...
TEXT ·ForwardAVX2Size4Radix4Complex128Asm(SB), NOSPLIT, $0-97
	// Load parameters
	...
	MOVQ src_len+32(FP), R13     // R13 = n (should be 4)
...
// ===========================================================================
TEXT ·InverseAVX2Size4Radix4Complex128Asm(SB), NOSPLIT, $0-97
	// Load parameters
	MOVQ dst+0(FP), R8
	MOVQ R8, R14             // R14 = original dst pointer
	MOVQ src+24(FP), R9
