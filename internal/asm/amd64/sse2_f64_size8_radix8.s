...
TEXT ·ForwardSSE2Size8Radix8Complex128Asm(SB), NOSPLIT, $0-97
	...
	MOVAPD X0, X8
  ADDPD X4, X0
  SUBPD X4, X8 // X0=a0, X8=a1
	MOVAPD X2, X9
  ADDPD X6, X2
  SUBPD X6, X9 // X2=a2, X9=a3
	MOVAPD X1, X10
  ADDPD X5, X1
  SUBPD X5, X10 // X1=a4, X10=a5
	MOVAPD X3, X11
  ADDPD X7, X3
  SUBPD X7, X11 // X3=a6, X11=a7

	// Stage 2: Even terms (e0..e3)
	MOVAPD X0, X4
  ADDPD X2, X0
  SUBPD X2, X4 // X0=e0, X4=e2
	// e1 = a1 + mulNegI(a3)
	MOVAPD X9, X5
  SHUFPD $1, X5, X5
  XORPD X15, X5 // t = a3 * -i
	MOVAPD X8, X6
  ADDPD X5, X8
  SUBPD X5, X6 // X8=e1, X6=e3 (Wait, e3 is X6)
	
	// Odd terms (o0..o3)
	MOVAPD X1, X5
  ADDPD X3, X1
  SUBPD X3, X5 // X1=o0, X5=o2
	// o1 = a5 + mulNegI(a7)
	MOVAPD X11, X7
  SHUFPD $1, X7, X7
  XORPD X15, X7 // t = a7 * -i
