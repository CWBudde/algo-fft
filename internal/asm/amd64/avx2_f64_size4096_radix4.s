...
//
// Shares the ·bitrev4096_r4 table with the complex64 kernel
// (avx2_f32_size4096_radix4.s).
//
// ===========================================================================
...
r4_4096_stage6_outer:
	CMPQ CX, $4096
	JGE  r4_4096_done

	XORQ DX, DX

r4_4096_stage6_inner:
	CMPQ DX, $1024
	JGE  r4_4096_stage6_next
	...
	INCQ DX
	JMP  r4_4096_stage6_inner

r4_4096_stage6_next:
	ADDQ $4096, CX
	JMP  r4_4096_stage6_outer
...
r4_4096_inv_stage6_outer:
	CMPQ CX, $4096
	JGE  r4_4096_inv_scale

	XORQ DX, DX

r4_4096_inv_stage6_inner:
	CMPQ DX, $1024
	JGE  r4_4096_inv_stage6_next
	...
	INCQ DX
	JMP  r4_4096_inv_stage6_inner

r4_4096_inv_stage6_next:
	ADDQ $4096, CX
	JMP  r4_4096_inv_stage6_outer
