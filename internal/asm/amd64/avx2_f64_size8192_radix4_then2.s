...
// ===========================================================================
// AVX2 Size-8192 Radix-4-then-2 FFT Kernels for AMD64
// ===========================================================================
//
// This file contains a radix-4-then-2 DIT FFT optimized for size 8192.
// Stages:
...
TEXT ·ForwardAVX2Size8192Radix4Then2Complex128Asm(SB), NOSPLIT, $0-97
	// Load parameters
...
// ===========================================================================
// Inverse transform, size 8192, complex128, radix-4-then-2
// ===========================================================================
TEXT ·InverseAVX2Size8192Radix4Then2Complex128Asm(SB), NOSPLIT, $0-97
	// Load parameters
	MOVQ dst+0(FP), R8       // R8  = dst pointer
	MOVQ src+24(FP), R9      // R9  = src pointer
	MOVQ twiddle+48(FP), R10 // R10 = twiddle pointer
...
m24_8192_inv_scale:
	...
	// ==================================================================
	VMOVSD ·eightThousandOneHundredThirtySecond64(SB), X8
	VBROADCASTSD X8, Y8
