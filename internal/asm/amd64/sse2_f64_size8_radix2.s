...
fwd_use_dst:
	...
	MOVAPD X0, X8
  ADDPD X1, X0
  SUBPD X1, X8 // X0=W0, X8=W1
	MOVAPD X2, X9
  ADDPD X3, X2
  SUBPD X3, X9 // X2=W2, X9=W3
	MOVAPD X4, X10
  ADDPD X5, X4
  SUBPD X5, X10 // X4=W4, X10=W5
	MOVAPD X6, X11
  ADDPD X7, X6
  SUBPD X7, X11 // X6=W6, X11=W7
	...
	MOVAPD X0, X1
  ADDPD X2, X0
  SUBPD X2, X1 // X0=y0, X1=y2
	MOVAPD X4, X5
  ADDPD X6, X4
  SUBPD X6, X5 // X4=y4, X5=y6
	// j=1 (w=-i)
	// y1, y3
	MOVAPD X9, X2
  SHUFPD $1, X2, X2
  ...
  SHUFPD $1, X12, X12
  MULPD X9, X12
	XORPD ·maskNegLoPD(SB), X12
  ADDPD X12, X6 // t = y5 * w1
	MOVAPD X8, X12
  ADDPD X6, X8
  SUBPD X6, X12
	MOVUPD X8, 16(R14)
