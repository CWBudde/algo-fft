...
// ===========================================================================
// AVX2 Size-32 Radix-4-then-2 FFT Kernels for AMD64
// ===========================================================================
//
...
TEXT ·ForwardAVX2Size32Radix4Then2Complex64Asm(SB), NOSPLIT, $0-97
	// Load parameters
...
TEXT ·InverseAVX2Size32Radix4Then2Complex64Asm(SB), NOSPLIT, $0-97
	// Load parameters
	MOVQ dst+0(FP), R8
	MOVQ src+24(FP), R9
