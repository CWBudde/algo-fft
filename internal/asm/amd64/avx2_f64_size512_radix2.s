...
size512_128_r2_bitrev_loop:
	CMPQ CX, $512
	JGE  size512_128_r2_stage1
	...
	MOVUPD X0, (R8)(SI*1)
	INCQ CX
	JMP  size512_128_r2_bitrev_loop

size512_128_r2_stage1:
	// Stage 1: size=2, half=1
	XORQ CX, CX

size512_128_r2_stage1_base:
	CMPQ CX, $512
	JGE  size512_128_r2_stage2
	...
	ADDQ $2, CX
	JMP  size512_128_r2_stage1_base
...
size512_inv_128_r2_bitrev_loop:
	CMPQ CX, $512
	JGE  size512_inv_128_r2_stage1
	MOVQ (R12)(CX*8), DX
	MOVQ DX, SI
	SHLQ $4, SI
	MOVUPD (R9)(SI*1), X0
	...
	MOVUPD X0, (R8)(SI*1)
	INCQ CX
	JMP  size512_inv_128_r2_bitrev_loop

size512_inv_128_r2_stage1:
	XORQ CX, CX

size512_inv_128_r2_stage1_base:
	CMPQ CX, $512
	JGE  size512_inv_128_r2_stage2
	MOVQ CX, SI
	SHLQ $4, SI
	MOVQ CX, DI
	INCQ DI
	...
	MOVUPD X3, (R8)(DI*1)
	ADDQ $2, CX
	JMP  size512_inv_128_r2_stage1_base
