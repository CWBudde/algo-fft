...
m24_32_f64_fwd_stage2_inner:
  ...
  SHLQ $1, AX
  SHLQ $4, AX
  MOVUPD (R10)(AX*1), X8 // w[2j]
	MOVQ DX, AX
  SHLQ $2, AX
  SHLQ $4, AX
  MOVUPD (R10)(AX*1), X9 // w[4j]
	MOVQ DX, AX
  SHLQ $1, AX
  ADDQ DX, AX
  SHLQ $1, AX
  SHLQ $4, AX
  MOVUPD (R10)(AX*1), X10 // w[6j]
...
m24_32_f64_inv_stage2_inner:
  ...
  SHLQ $4, AX
  MOVUPD (R10)(AX*1), X8
  XORPD X15, X8 // conj(w[2j])
	MOVQ DX, AX
  SHLQ $1, AX
  SHLQ $1, AX
  SHLQ $4, AX
  MOVUPD (R10)(AX*1), X9
  XORPD X15, X9 // conj(w[4j])
	MOVQ DX, AX
  SHLQ $1, AX
  ADDQ DX, AX
  SHLQ $1, AX
