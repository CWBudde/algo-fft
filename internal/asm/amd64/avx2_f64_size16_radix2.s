...
// ===========================================================================
// AVX2 Size-16 Radix-2 FFT (complex128) Kernels for AMD64
// ===========================================================================
//
// This file contains fully-unrolled FFT kernels optimized for size 16 complex128.
...
#include "textflag.h"
TEXT ·ForwardAVX2Size16Radix2Complex128Asm(SB), NOSPLIT, $0-97
	// Load parameters
	...
	MOVQ src_len+32(FP), R13     // n (should be 16)
...
// ===========================================================================
TEXT ·InverseAVX2Size16Radix2Complex128Asm(SB), NOSPLIT, $0-97
	// Load parameters
	MOVQ dst+0(FP), R8
	MOVQ src+24(FP), R9
