...
size512_r8_128_fwd_stage1_loop:
	...
	VMOVUPD X5, 0(R14)(BX*1)   // y0
	VMOVUPD X7, 64(R14)(BX*1)  // y4
	VMOVUPD X8, 16(R14)(BX*1)  // y1
	VMOVUPD X9, 80(R14)(BX*1)  // y5
	VMOVUPD X1, 32(R14)(BX*1)  // y2
	VMOVUPD X11, 96(R14)(BX*1) // y6
	VMOVUPD X6, 48(R14)(BX*1)  // y3
	VMOVUPD X4, 112(R14)(BX*1) // y7
...
size512_r8_128_fwd_stage2_inner:
	...
	VMOVUPD 0(R14)(SI*1), X0
	VMOVUPD 128(R14)(SI*1), X1
	VMOVUPD 256(R14)(SI*1), X2
	VMOVUPD 384(R14)(SI*1), X3
	VMOVUPD 512(R14)(SI*1), X4
	VMOVUPD 640(R14)(SI*1), X5
	VMOVUPD 768(R14)(SI*1), X6
	VMOVUPD 896(R14)(SI*1), X7
	...
	VMOVUPD X5, 0(R8)(SI*1)    // y0
	VMOVUPD X7, 512(R8)(SI*1)  // y4
	VMOVUPD X8, 128(R8)(SI*1)  // y1
	VMOVUPD X9, 640(R8)(SI*1)  // y5
	VMOVUPD X1, 256(R8)(SI*1)  // y2
	VMOVUPD X11, 768(R8)(SI*1) // y6
	VMOVUPD X6, 384(R8)(SI*1)  // y3
	VMOVUPD X4, 896(R8)(SI*1)  // y7
...
size512_r8_128_fwd_stage3_loop:
	...
	VMOVUPD 0(R8)(SI*1), X0
	VMOVUPD 1024(R8)(SI*1), X1
	VMOVUPD 2048(R8)(SI*1), X2
	VMOVUPD 3072(R8)(SI*1), X3
	VMOVUPD 4096(R8)(SI*1), X4
	VMOVUPD 5120(R8)(SI*1), X5
	VMOVUPD 6144(R8)(SI*1), X6
	VMOVUPD 7168(R8)(SI*1), X7
	...
	VMOVUPD X5, 0(R8)(SI*1)     // y0
	VMOVUPD X7, 4096(R8)(SI*1)  // y4
	VMOVUPD X8, 1024(R8)(SI*1)  // y1
	VMOVUPD X9, 5120(R8)(SI*1)  // y5
	VMOVUPD X1, 2048(R8)(SI*1)  // y2
	VMOVUPD X11, 6144(R8)(SI*1) // y6
	VMOVUPD X6, 3072(R8)(SI*1)  // y3
	VMOVUPD X4, 7168(R8)(SI*1)  // y7
...
size512_r8_128_inv_stage1_loop:
	...
	MOVQ CX, BX
	SHLQ $4, BX
	VMOVUPD X5, 0(R14)(BX*1)
	VMOVUPD X7, 64(R14)(BX*1)
	VMOVUPD X8, 16(R14)(BX*1)
	VMOVUPD X9, 80(R14)(BX*1)
	VMOVUPD X1, 32(R14)(BX*1)
	VMOVUPD X11, 96(R14)(BX*1)
	VMOVUPD X6, 48(R14)(BX*1)
	VMOVUPD X4, 112(R14)(BX*1)
...
size512_r8_128_inv_stage2_inner:
	...
	VMOVUPD X5, 0(R8)(SI*1)
	VMOVUPD X7, 512(R8)(SI*1)
	VMOVUPD X8, 128(R8)(SI*1)
	VMOVUPD X9, 640(R8)(SI*1)
	VMOVUPD X1, 256(R8)(SI*1)
	VMOVUPD X11, 768(R8)(SI*1)
	VMOVUPD X6, 384(R8)(SI*1)
	VMOVUPD X4, 896(R8)(SI*1)
...
size512_r8_128_inv_stage3_loop:
	...
	VMOVUPD X5, 0(R8)(SI*1)
	VMOVUPD X7, 4096(R8)(SI*1)
	VMOVUPD X8, 1024(R8)(SI*1)
	VMOVUPD X9, 5120(R8)(SI*1)
	VMOVUPD X1, 2048(R8)(SI*1)
	VMOVUPD X11, 6144(R8)(SI*1)
	VMOVUPD X6, 3072(R8)(SI*1)
	VMOVUPD X4, 7168(R8)(SI*1)
...
size512_r8_128_inv_scale:
	...
	VMOVSD ·fiveHundredTwelfth64(SB), X8
	VBROADCASTSD X8, Y8
	MOVQ dst+0(FP), R9
	XORQ CX, CX
