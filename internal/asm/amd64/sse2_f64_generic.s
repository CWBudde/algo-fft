...
TEXT ·ForwardSSE2Complex128Asm(SB), NOSPLIT|NOFRAME, $0-97
	MOVB $0, ret+96(FP)        // Return false (use Go fallback)
	RET

TEXT ·InverseSSE2Complex128Asm(SB), NOSPLIT|NOFRAME, $0-97
	MOVB $0, ret+96(FP)        // Return false (use Go fallback)
	RET
