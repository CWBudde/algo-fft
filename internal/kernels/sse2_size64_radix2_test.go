...
func TestForwardSSE2Size64Radix2Complex64(t *testing.T) {
	const n = 64
	...
	copy(want, src)
	forwardDIT64Complex64(want, want, twiddle, scratch, bitrev)
...
func TestInverseSSE2Size64Radix2Complex64(t *testing.T) {
	const n = 64
...
func TestRoundTripSSE2Size64Radix2Complex64(t *testing.T) {
	const n = 64
