...
func TestForwardSSE2Size8Radix8Complex64(t *testing.T) {
	...
	if !amd64.ForwardSSE2Size8Radix8Complex64Asm(dst, src, twiddle, scratch) {
...
func TestInverseSSE2Size8Radix8Complex64(t *testing.T) {
	...
	if !amd64.InverseSSE2Size8Radix8Complex64Asm(dst, fwd, twiddle, scratch) {
...
func TestRoundTripSSE2Size8Radix8Complex64(t *testing.T) {
	...
	// Forward transform
	if !amd64.ForwardSSE2Size8Radix8Complex64Asm(fwd, src, twiddle, scratch) {
		t.Fatal("forward transform failed")
	}

	// Inverse transform
	if !amd64.InverseSSE2Size8Radix8Complex64Asm(inv, fwd, twiddle, scratch) {
