// Code generated by genkernels from dit_8192_radix4_then2.go. DO NOT EDIT.
...
func forwardDIT8192Radix4Then2Complex128(dst, src, twiddle, scratch []complex128) bool {
	...
	var stage1Backing [n]complex128
	...
	var stage2Backing [n]complex128
	...
	for base := 0; base < n; base += 16 {
		for j := range 4 {
			...
			a0 := stage1[idx0]
			a1 := mathpkg.MulComplex128(w1, stage1[idx1])
			a2 := mathpkg.MulComplex128(w2, stage1[idx2])
			a3 := mathpkg.MulComplex128(w3, stage1[idx3])
	...
	var stage3Backing [n]complex128
	...
	var stage4Backing [n]complex128
	...
	var stage5Backing [n]complex128
	...
	var stage6Backing [n]complex128
	...
	for base := 0; base < n; base += 4096 {
		for j := range 1024 {
			...
			a0 := stage5[idx0]
			a1 := mathpkg.MulComplex128(w1, stage5[idx1])
			a2 := mathpkg.MulComplex128(w2, stage5[idx2])
			a3 := mathpkg.MulComplex128(w3, stage5[idx3])
	...
	for j := range 4096 {
		tw := tw[j]
		a := stage6[j]
		b := mathpkg.MulComplex128(tw, stage6[j+4096])
		work[j] = a + b
		work[j+4096] = a - b
	}
