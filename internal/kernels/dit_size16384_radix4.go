...
func forwardDIT16384Radix4Complex64(dst, src, twiddle, scratch []complex64) bool {
	const n = 16384
...
// radix-4 Decimation-in-Time (DIT) algorithm for complex64 data.
func inverseDIT16384Radix4Complex64(dst, src, twiddle, scratch []complex64) bool {
	const n = 16384
...
func forwardDIT16384Radix4Complex128(dst, src, twiddle, scratch []complex128) bool {
	const n = 16384
...
// radix-4 Decimation-in-Time (DIT) algorithm for complex128 data.
func inverseDIT16384Radix4Complex128(dst, src, twiddle, scratch []complex128) bool {
	const n = 16384
