...
func Butterfly7ForwardComplex128(a *[7]complex128) {
	y0, m1, q1, m2, q2, m3, q3 := butterfly7CoreComplex128(a)
...
// butterfly7CoreComplex128 computes the direction-independent half of the
...
func butterfly7CoreComplex128(a *[7]complex128) (y0, m1, q1, m2, q2, m3, q3 complex128) {
	c1, c2, c3 := radix7Cos128[0], radix7Cos128[1], radix7Cos128[2]
	s1, s2, s3 := radix7Sin128[0], radix7Sin128[1], radix7Sin128[2]
