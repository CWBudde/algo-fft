...
func TestForwardSSE2Size16Radix4Complex128(t *testing.T) {
	...
	copy(want, src)
	forwardDIT16Radix4Complex128(want, want, twiddle, scratch)

	if !amd64.ForwardSSE2Size16Radix4Complex128Asm(dst, src, twiddle, scratch) {
...
func TestInverseSSE2Size16Radix4Complex128(t *testing.T) {
	...
	want := make([]complex128, n)
	copy(want, src)
	inverseDIT16Radix4Complex128(want, want, twiddle, scratch)

	if !amd64.InverseSSE2Size16Radix4Complex128Asm(dst, src, twiddle, scratch) {
...
func TestRoundTripSSE2Size16Radix4Complex128(t *testing.T) {
	...
	if !amd64.ForwardSSE2Size16Radix4Complex128Asm(fwd, src, twiddle, scratch) {
		t.Fatal("Forward failed")
	}
	if !amd64.InverseSSE2Size16Radix4Complex128Asm(inv, fwd, twiddle, scratch) {
