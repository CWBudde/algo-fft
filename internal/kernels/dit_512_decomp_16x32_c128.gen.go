// Code generated by genkernels from dit_512_decomp_16x32.go. DO NOT EDIT.
...
func forwardDIT512Mixed16x32Complex128(dst, src, twiddle, scratch []complex128) bool {
	...
	// Since we don't have a correct fft32Complex128, we implement it as two layers of FFT-16
...
func inverseDIT512Mixed16x32Complex128(dst, src, twiddle, scratch []complex128) bool {
	...
	for n1 := range 16 {
		...
		// n2 = 0: W_32^0 = 1
		dst[16*0+n1] = mathpkg.ScaleComplex128(e0+o0, scale)
		dst[16*16+n1] = mathpkg.ScaleComplex128(e0-o0, scale)

		// n2 = 1: W_32^{-1} = conj(tw[16])
		t1 := mathpkg.MulComplex128(o1, cw1)
		dst[16*1+n1] = mathpkg.ScaleComplex128(e1+t1, scale)
		dst[16*17+n1] = mathpkg.ScaleComplex128(e1-t1, scale)

		// n2 = 2: W_32^{-2} = conj(tw[32])
		t2 := mathpkg.MulComplex128(o2, cw2)
		dst[16*2+n1] = mathpkg.ScaleComplex128(e2+t2, scale)
		dst[16*18+n1] = mathpkg.ScaleComplex128(e2-t2, scale)

		// n2 = 3: W_32^{-3} = conj(tw[48])
		t3 := mathpkg.MulComplex128(o3, cw3)
		dst[16*3+n1] = mathpkg.ScaleComplex128(e3+t3, scale)
		dst[16*19+n1] = mathpkg.ScaleComplex128(e3-t3, scale)

		// n2 = 4: W_32^{-4} = conj(tw[64])
		t4 := mathpkg.MulComplex128(o4, cw4)
		dst[16*4+n1] = mathpkg.ScaleComplex128(e4+t4, scale)
		dst[16*20+n1] = mathpkg.ScaleComplex128(e4-t4, scale)

		// n2 = 5: W_32^{-5} = conj(tw[80])
		t5 := mathpkg.MulComplex128(o5, cw5)
		dst[16*5+n1] = mathpkg.ScaleComplex128(e5+t5, scale)
		dst[16*21+n1] = mathpkg.ScaleComplex128(e5-t5, scale)

		// n2 = 6: W_32^{-6} = conj(tw[96])
		t6 := mathpkg.MulComplex128(o6, cw6)
		dst[16*6+n1] = mathpkg.ScaleComplex128(e6+t6, scale)
		dst[16*22+n1] = mathpkg.ScaleComplex128(e6-t6, scale)

		// n2 = 7: W_32^{-7} = conj(tw[112])
		t7 := mathpkg.MulComplex128(o7, cw7)
		dst[16*7+n1] = mathpkg.ScaleComplex128(e7+t7, scale)
		dst[16*23+n1] = mathpkg.ScaleComplex128(e7-t7, scale)

		// n2 = 8: W_32^{-8} = conj(tw[128])
		t8 := mathpkg.MulComplex128(o8, cw8)
		dst[16*8+n1] = mathpkg.ScaleComplex128(e8+t8, scale)
		dst[16*24+n1] = mathpkg.ScaleComplex128(e8-t8, scale)

		// n2 = 9: W_32^{-9} = conj(tw[144])
		t9 := mathpkg.MulComplex128(o9, cw9)
		dst[16*9+n1] = mathpkg.ScaleComplex128(e9+t9, scale)
		dst[16*25+n1] = mathpkg.ScaleComplex128(e9-t9, scale)

		// n2 = 10: W_32^{-10} = conj(tw[160])
		t10 := mathpkg.MulComplex128(o10, cw10)
		dst[16*10+n1] = mathpkg.ScaleComplex128(e10+t10, scale)
		dst[16*26+n1] = mathpkg.ScaleComplex128(e10-t10, scale)

		// n2 = 11: W_32^{-11} = conj(tw[176])
		t11 := mathpkg.MulComplex128(o11, cw11)
		dst[16*11+n1] = mathpkg.ScaleComplex128(e11+t11, scale)
		dst[16*27+n1] = mathpkg.ScaleComplex128(e11-t11, scale)

		// n2 = 12: W_32^{-12} = conj(tw[192])
		t12 := mathpkg.MulComplex128(o12, cw12)
		dst[16*12+n1] = mathpkg.ScaleComplex128(e12+t12, scale)
		dst[16*28+n1] = mathpkg.ScaleComplex128(e12-t12, scale)

		// n2 = 13: W_32^{-13} = conj(tw[208])
		t13 := mathpkg.MulComplex128(o13, cw13)
		dst[16*13+n1] = mathpkg.ScaleComplex128(e13+t13, scale)
		dst[16*29+n1] = mathpkg.ScaleComplex128(e13-t13, scale)

		// n2 = 14: W_32^{-14} = conj(tw[224])
		t14 := mathpkg.MulComplex128(o14, cw14)
		dst[16*14+n1] = mathpkg.ScaleComplex128(e14+t14, scale)
		dst[16*30+n1] = mathpkg.ScaleComplex128(e14-t14, scale)

		// n2 = 15: W_32^{-15} = conj(tw[240])
		t15 := mathpkg.MulComplex128(o15, cw15)
		dst[16*15+n1] = mathpkg.ScaleComplex128(e15+t15, scale)
		dst[16*31+n1] = mathpkg.ScaleComplex128(e15-t15, scale)
	}
