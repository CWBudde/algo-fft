...
func TestForwardDIT8Radix4Complex64(t *testing.T) {
	...
	if !forwardDIT8Radix4Complex64(dst, src, twiddle, scratch) {
...
func TestInverseDIT8Radix4Complex64(t *testing.T) {
	...
	if !forwardDIT8Radix4Complex64(fwd, src, twiddle, scratch) {
		t.Fatal("forwardDIT8Radix4Complex64 failed")
	}

	if !inverseDIT8Radix4Complex64(dst, fwd, twiddle, scratch) {
...
func TestForwardDIT8Radix4Complex128(t *testing.T) {
	...
	if !forwardDIT8Radix4Complex128(dst, src, twiddle, scratch) {
...
func TestInverseDIT8Radix4Complex128(t *testing.T) {
	...
	if !forwardDIT8Radix4Complex128(fwd, src, twiddle, scratch) {
		t.Fatal("forwardDIT8Radix4Complex128 failed")
	}

	if !inverseDIT8Radix4Complex128(dst, fwd, twiddle, scratch) {
