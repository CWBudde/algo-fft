...
func TestForwardSSE2Size128Radix2Complex64(t *testing.T) {
	...
	copy(want, src)
	forwardDIT128Complex64(want, want, twiddle, scratch)

	if !amd64.ForwardSSE2Size128Radix2Complex64Asm(dst, src, twiddle, scratch) {
...
func TestInverseSSE2Size128Radix2Complex64(t *testing.T) {
	...
	want := make([]complex64, n)
	copy(want, src)
	inverseDIT128Complex64(want, want, twiddle, scratch)

	if !amd64.InverseSSE2Size128Radix2Complex64Asm(dst, src, twiddle, scratch) {
...
func TestRoundTripSSE2Size128Radix2Complex64(t *testing.T) {
	...
	if !amd64.ForwardSSE2Size128Radix2Complex64Asm(fwd, src, twiddle, scratch) {
		t.Fatal("Forward failed")
	}
	if !amd64.InverseSSE2Size128Radix2Complex64Asm(inv, fwd, twiddle, scratch) {
