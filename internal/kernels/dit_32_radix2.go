...
func forwardDIT32Radix2Complex64(dst, src, twiddle, scratch []complex64) bool {
	...
	b0, b2 := a0+a2, a0-a2
	t := mathpkg.MulComplex64(w8, a3)
	b1, b3 := a1+t, a1-t
	b4, b6 := a4+a6, a4-a6
	t = mathpkg.MulComplex64(w8, a7)
	b5, b7 := a5+t, a5-t
	b8, b10 := a8+a10, a8-a10
	t = mathpkg.MulComplex64(w8, a11)
	b9, b11 := a9+t, a9-t
	b12, b14 := a12+a14, a12-a14
	t = mathpkg.MulComplex64(w8, a15)
	b13, b15 := a13+t, a13-t
	b16, b18 := a16+a18, a16-a18
	t = mathpkg.MulComplex64(w8, a19)
	b17, b19 := a17+t, a17-t
	b20, b22 := a20+a22, a20-a22
	t = mathpkg.MulComplex64(w8, a23)
	b21, b23 := a21+t, a21-t
	b24, b26 := a24+a26, a24-a26
	t = mathpkg.MulComplex64(w8, a27)
	b25, b27 := a25+t, a25-t
	b28, b30 := a28+a30, a28-a30
	t = mathpkg.MulComplex64(w8, a31)
	b29, b31 := a29+t, a29-t

	// Stage 3: 4 radix-2 butterflies, stride=8
	c0, c4 := b0+b4, b0-b4
	t = mathpkg.MulComplex64(w4, b5)
	c1, c5 := b1+t, b1-t
	t = mathpkg.MulComplex64(w8, b6)
	c2, c6 := b2+t, b2-t
	t = mathpkg.MulComplex64(w12, b7)
	c3, c7 := b3+t, b3-t
	c8, c12 := b8+b12, b8-b12
	t = mathpkg.MulComplex64(w4, b13)
	c9, c13 := b9+t, b9-t
	t = mathpkg.MulComplex64(w8, b14)
	c10, c14 := b10+t, b10-t
	t = mathpkg.MulComplex64(w12, b15)
	c11, c15 := b11+t, b11-t
	c16, c20 := b16+b20, b16-b20
	t = mathpkg.MulComplex64(w4, b21)
	c17, c21 := b17+t, b17-t
	t = mathpkg.MulComplex64(w8, b22)
	c18, c22 := b18+t, b18-t
	t = mathpkg.MulComplex64(w12, b23)
	c19, c23 := b19+t, b19-t
	c24, c28 := b24+b28, b24-b28
	t = mathpkg.MulComplex64(w4, b29)
	c25, c29 := b25+t, b25-t
	t = mathpkg.MulComplex64(w8, b30)
	c26, c30 := b26+t, b26-t
	t = mathpkg.MulComplex64(w12, b31)
	c27, c31 := b27+t, b27-t

	// Stage 4: 2 radix-2 butterflies, stride=16
	d0, d8 := c0+c8, c0-c8
	t = mathpkg.MulComplex64(w2, c9)
	d1, d9 := c1+t, c1-t
	t = mathpkg.MulComplex64(w4, c10)
	d2, d10 := c2+t, c2-t
	t = mathpkg.MulComplex64(w6, c11)
	d3, d11 := c3+t, c3-t
	t = mathpkg.MulComplex64(w8, c12)
	d4, d12 := c4+t, c4-t
	t = mathpkg.MulComplex64(w10, c13)
	d5, d13 := c5+t, c5-t
	t = mathpkg.MulComplex64(w12, c14)
	d6, d14 := c6+t, c6-t
	t = mathpkg.MulComplex64(w14, c15)
	d7, d15 := c7+t, c7-t
	d16, d24 := c16+c24, c16-c24
	t = mathpkg.MulComplex64(w2, c25)
	d17, d25 := c17+t, c17-t
	t = mathpkg.MulComplex64(w4, c26)
	d18, d26 := c18+t, c18-t
	t = mathpkg.MulComplex64(w6, c27)
	d19, d27 := c19+t, c19-t
	t = mathpkg.MulComplex64(w8, c28)
	d20, d28 := c20+t, c20-t
	t = mathpkg.MulComplex64(w10, c29)
	d21, d29 := c21+t, c21-t
	t = mathpkg.MulComplex64(w12, c30)
	d22, d30 := c22+t, c22-t
	t = mathpkg.MulComplex64(w14, c31)
	d23, d31 := c23+t, c23-t
	...
	t = mathpkg.MulComplex64(w1, d17)
	work[1], work[17] = d1+t, d1-t
	t = mathpkg.MulComplex64(w2, d18)
	work[2], work[18] = d2+t, d2-t
	t = mathpkg.MulComplex64(w3, d19)
	work[3], work[19] = d3+t, d3-t
	t = mathpkg.MulComplex64(w4, d20)
	work[4], work[20] = d4+t, d4-t
	t = mathpkg.MulComplex64(w5, d21)
	work[5], work[21] = d5+t, d5-t
	t = mathpkg.MulComplex64(w6, d22)
	work[6], work[22] = d6+t, d6-t
	t = mathpkg.MulComplex64(w7, d23)
	work[7], work[23] = d7+t, d7-t
	t = mathpkg.MulComplex64(w8, d24)
	work[8], work[24] = d8+t, d8-t
	t = mathpkg.MulComplex64(w9, d25)
	work[9], work[25] = d9+t, d9-t
	t = mathpkg.MulComplex64(w10, d26)
	work[10], work[26] = d10+t, d10-t
	t = mathpkg.MulComplex64(w11, d27)
	work[11], work[27] = d11+t, d11-t
	t = mathpkg.MulComplex64(w12, d28)
	work[12], work[28] = d12+t, d12-t
	t = mathpkg.MulComplex64(w13, d29)
	work[13], work[29] = d13+t, d13-t
	t = mathpkg.MulComplex64(w14, d30)
	work[14], work[30] = d14+t, d14-t
	t = mathpkg.MulComplex64(w15, d31)
