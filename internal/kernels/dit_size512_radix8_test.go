...
func TestForwardDIT512Radix8Complex64(t *testing.T) {
	...
	bitrev := mathpkg.ComputePermutationIndices(n, 8) // Radix-8 digit-reversal

	if !forwardDIT512Radix8Complex64(dst, src, twiddle, scratch, bitrev) {
...
func TestInverseDIT512Radix8Complex64(t *testing.T) {
	...
	if !forwardDIT512Radix8Complex64(fwd, src, twiddle, scratch, bitrev) {
		t.Fatal("forwardDIT512Radix8Complex64 failed")
	}

	if !inverseDIT512Radix8Complex64(dst, fwd, twiddle, scratch, bitrev) {
...
func TestForwardDIT512Radix8Complex128(t *testing.T) {
	...
	if !forwardDIT512Radix8Complex128(dst, src, twiddle, scratch, bitrev) {
...
func TestInverseDIT512Radix8Complex128(t *testing.T) {
	...
	if !forwardDIT512Radix8Complex128(fwd, src, twiddle, scratch, bitrev) {
		t.Fatal("forwardDIT512Radix8Complex128 failed")
	}

	if !inverseDIT512Radix8Complex128(dst, fwd, twiddle, scratch, bitrev) {
