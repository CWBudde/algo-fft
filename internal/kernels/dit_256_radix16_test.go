...
// TestRoundTripDIT256Radix16Complex64 tests forward then inverse returns original.
func TestRoundTripDIT256Radix16Complex64(t *testing.T) {
	t.Parallel()
...
// TestRoundTripDIT256Radix16Complex128 tests forward then inverse returns original (complex128).
func TestRoundTripDIT256Radix16Complex128(t *testing.T) {
	t.Parallel()
