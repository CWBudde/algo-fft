...
func BenchmarkDITComplex64(b *testing.B) {
	cases := []benchCase64{
		...
		{"Size32/Radix4x4x2", 32, forwardDIT32MixedRadix24Complex64, inverseDIT32MixedRadix24Complex64},
		...
		{"Size512/Mixed24", 512, forwardDIT512Mixed24Complex64, inverseDIT512Mixed24Complex64},
...
func BenchmarkDITComplex128(b *testing.B) {
	cases := []benchCase128{
		...
		{"Size32/Radix4x4x2", 32, forwardDIT32MixedRadix24Complex128, inverseDIT32MixedRadix24Complex128},
		...
		{"Size512/Mixed24", 512, forwardDIT512Mixed24Complex128, inverseDIT512Mixed24Complex128},
