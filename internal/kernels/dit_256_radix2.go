...
func forwardDIT256Complex64(dst, src, twiddle, scratch []complex64) bool {
	...
	for base := 0; base < n; base += 32 {
		for j := 0; j < 16; j += 4 {
			...
			t0, t1, t2, t3 := mathpkg.MulComplex64(tw0, y0), mathpkg.MulComplex64(tw1, y1), mathpkg.MulComplex64(tw2, y2), mathpkg.MulComplex64(tw3, y3)
