...
func TestRoundTripSSE2Size256Radix2Complex128(t *testing.T) {
	...
	if !amd64.ForwardSSE2Size256Radix2Complex128Asm(fwd, src, twiddle, scratch, bitrev) {
		t.Fatal("Forward failed")
	}
	if !amd64.InverseSSE2Size256Radix2Complex128Asm(inv, fwd, twiddle, scratch, bitrev) {
