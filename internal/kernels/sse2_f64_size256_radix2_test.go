...
func TestForwardSSE2Size256Radix2Complex128(t *testing.T) {
	const n = 256
	...
	if !amd64.ForwardSSE2Size256Radix2Complex128Asm(dst, src, twiddle, scratch) {
...
func TestInverseSSE2Size256Radix2Complex128(t *testing.T) {
	const n = 256
	...
	if !amd64.InverseSSE2Size256Radix2Complex128Asm(dst, src, twiddle, scratch) {
...
func TestRoundTripSSE2Size256Radix2Complex128(t *testing.T) {
	const n = 256
	...
	if !amd64.ForwardSSE2Size256Radix2Complex128Asm(fwd, src, twiddle, scratch) {
		t.Fatal("Forward failed")
	}
	if !amd64.InverseSSE2Size256Radix2Complex128Asm(inv, fwd, twiddle, scratch) {
