...
func registerNEONDITCodelets64() {
	// Size 4: Radix-4 NEON variant (identity permutation, bitrev embedded)
	Registry64.Register(CodeletEntry[complex64]{
		...
		Priority:   10,
		KernelType: KernelTypeDIT, // Self-contained, bitrev embedded
	})
	...
	// Size 256: radix-4 NEON variant
	Registry64.Register(CodeletEntry[complex64]{
		Size:       256,
		Forward:    wrapCodelet64(arm64.ForwardNEONSize256Radix4Complex64Asm),
		Inverse:    wrapCodelet64(arm64.InverseNEONSize256Radix4Complex64Asm),
		Algorithm:  KernelDIT,
		SIMDLevel:  SIMDNEON,
