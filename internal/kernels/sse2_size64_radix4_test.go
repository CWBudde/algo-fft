...
func TestForwardSSE2Size64Radix4Complex64(t *testing.T) {
	...
	if !amd64.ForwardSSE2Size64Radix4Complex64Asm(dst, src, twiddle, scratch) {
...
func TestInverseSSE2Size64Radix4Complex64(t *testing.T) {
	...
	if !amd64.ForwardSSE2Size64Radix4Complex64Asm(fwd, src, twiddle, scratch) {
		t.Fatal("ForwardSSE2Size64Radix4Complex64Asm failed")
	}

	if !amd64.InverseSSE2Size64Radix4Complex64Asm(dst, fwd, twiddle, scratch) {
...
func TestRoundTripSSE2Size64Radix4Complex64(t *testing.T) {
	...
	// Inverse transform
	if !amd64.InverseSSE2Size64Radix4Complex64Asm(inv, fwd, twiddle, scratch) {
