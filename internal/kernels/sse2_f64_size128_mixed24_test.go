...
func TestForwardSSE2Size128Mixed24Complex128(t *testing.T) {
	const n = 128
	...
	if !amd64.ForwardSSE2Size128Mixed24Complex128Asm(dst, src, twiddle, scratch) {
...
func TestInverseSSE2Size128Mixed24Complex128(t *testing.T) {
	const n = 128
	...
	if !amd64.InverseSSE2Size128Mixed24Complex128Asm(dst, src, twiddle, scratch) {
...
func TestRoundTripSSE2Size128Mixed24Complex128(t *testing.T) {
	const n = 128
	...
	if !amd64.ForwardSSE2Size128Mixed24Complex128Asm(fwd, src, twiddle, scratch) {
		t.Fatal("Forward failed")
	}
	if !amd64.InverseSSE2Size128Mixed24Complex128Asm(inv, fwd, twiddle, scratch) {
