...
func TestRoundTripSSE2Size128Mixed24Complex128(t *testing.T) {
	...
	if !amd64.ForwardSSE2Size128Mixed24Complex128Asm(fwd, src, twiddle, scratch, bitrev) {
		t.Fatal("Forward failed")
	}
	if !amd64.InverseSSE2Size128Mixed24Complex128Asm(inv, fwd, twiddle, scratch, bitrev) {
