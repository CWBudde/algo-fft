...
func stage1ForwardDIT1024Radix32x32Complex64(out, src, tw []complex64) {
	for n1 := range 32 {
		...
		out[0*32+n1] = mathpkg.MulComplex64(e00+o00, tw[0])
		out[16*32+n1] = mathpkg.MulComplex64(e00-o00, tw[16*n1])

		t1 := mathpkg.MulComplex64(o01, tw[32])
		out[1*32+n1] = mathpkg.MulComplex64(e01+t1, tw[1*n1])
		out[17*32+n1] = mathpkg.MulComplex64(e01-t1, tw[17*n1])

		t2 := mathpkg.MulComplex64(o02, tw[64])
		out[2*32+n1] = mathpkg.MulComplex64(e02+t2, tw[2*n1])
		out[18*32+n1] = mathpkg.MulComplex64(e02-t2, tw[18*n1])

		t3 := mathpkg.MulComplex64(o03, tw[96])
		out[3*32+n1] = mathpkg.MulComplex64(e03+t3, tw[3*n1])
		out[19*32+n1] = mathpkg.MulComplex64(e03-t3, tw[19*n1])

		t4 := mathpkg.MulComplex64(o04, tw[128])
		out[4*32+n1] = mathpkg.MulComplex64(e04+t4, tw[4*n1])
		out[20*32+n1] = mathpkg.MulComplex64(e04-t4, tw[20*n1])

		t5 := mathpkg.MulComplex64(o05, tw[160])
		out[5*32+n1] = mathpkg.MulComplex64(e05+t5, tw[5*n1])
		out[21*32+n1] = mathpkg.MulComplex64(e05-t5, tw[21*n1])

		t6 := mathpkg.MulComplex64(o06, tw[192])
		out[6*32+n1] = mathpkg.MulComplex64(e06+t6, tw[6*n1])
		out[22*32+n1] = mathpkg.MulComplex64(e06-t6, tw[22*n1])

		t7 := mathpkg.MulComplex64(o07, tw[224])
		out[7*32+n1] = mathpkg.MulComplex64(e07+t7, tw[7*n1])
		out[23*32+n1] = mathpkg.MulComplex64(e07-t7, tw[23*n1])

		t8 := mathpkg.MulComplex64(o08, tw[256])
		out[8*32+n1] = mathpkg.MulComplex64(e08+t8, tw[8*n1])
		out[24*32+n1] = mathpkg.MulComplex64(e08-t8, tw[24*n1])

		t9 := mathpkg.MulComplex64(o09, tw[288])
		out[9*32+n1] = mathpkg.MulComplex64(e09+t9, tw[9*n1])
		out[25*32+n1] = mathpkg.MulComplex64(e09-t9, tw[25*n1])

		t10 := mathpkg.MulComplex64(o10, tw[320])
		out[10*32+n1] = mathpkg.MulComplex64(e10+t10, tw[10*n1])
		out[26*32+n1] = mathpkg.MulComplex64(e10-t10, tw[26*n1])

		t11 := mathpkg.MulComplex64(o11, tw[352])
		out[11*32+n1] = mathpkg.MulComplex64(e11+t11, tw[11*n1])
		out[27*32+n1] = mathpkg.MulComplex64(e11-t11, tw[27*n1])

		t12 := mathpkg.MulComplex64(o12, tw[384])
		out[12*32+n1] = mathpkg.MulComplex64(e12+t12, tw[12*n1])
		out[28*32+n1] = mathpkg.MulComplex64(e12-t12, tw[28*n1])

		t13 := mathpkg.MulComplex64(o13, tw[416])
		out[13*32+n1] = mathpkg.MulComplex64(e13+t13, tw[13*n1])
		out[29*32+n1] = mathpkg.MulComplex64(e13-t13, tw[29*n1])

		t14 := mathpkg.MulComplex64(o14, tw[448])
		out[14*32+n1] = mathpkg.MulComplex64(e14+t14, tw[14*n1])
		out[30*32+n1] = mathpkg.MulComplex64(e14-t14, tw[30*n1])

		t15 := mathpkg.MulComplex64(o15, tw[480])
		out[15*32+n1] = mathpkg.MulComplex64(e15+t15, tw[15*n1])
		out[31*32+n1] = mathpkg.MulComplex64(e15-t15, tw[31*n1])
	}
}
...
func inverseDIT1024Mixed32x32Complex64(dst, src, twiddle, scratch []complex64) bool {
	...
	for k2 := range 32 {
		...
		work[base+4] = mathpkg.MulComplex64(r4, complex(real(tw[k2*4]), -imag(tw[k2*4])))
		work[base+5] = mathpkg.MulComplex64(r5, complex(real(tw[k2*5]), -imag(tw[k2*5])))
		work[base+6] = mathpkg.MulComplex64(r6, complex(real(tw[k2*6]), -imag(tw[k2*6])))
		work[base+7] = mathpkg.MulComplex64(r7, complex(real(tw[k2*7]), -imag(tw[k2*7])))
		work[base+8] = mathpkg.MulComplex64(r8, complex(real(tw[k2*8]), -imag(tw[k2*8])))
		work[base+9] = mathpkg.MulComplex64(r9, complex(real(tw[k2*9]), -imag(tw[k2*9])))
		work[base+10] = mathpkg.MulComplex64(r10, complex(real(tw[k2*10]), -imag(tw[k2*10])))
		work[base+11] = mathpkg.MulComplex64(r11, complex(real(tw[k2*11]), -imag(tw[k2*11])))
		work[base+12] = mathpkg.MulComplex64(r12, complex(real(tw[k2*12]), -imag(tw[k2*12])))
		work[base+13] = mathpkg.MulComplex64(r13, complex(real(tw[k2*13]), -imag(tw[k2*13])))
		work[base+14] = mathpkg.MulComplex64(r14, complex(real(tw[k2*14]), -imag(tw[k2*14])))
		work[base+15] = mathpkg.MulComplex64(r15, complex(real(tw[k2*15]), -imag(tw[k2*15])))
		work[base+16] = mathpkg.MulComplex64(r16, complex(real(tw[k2*16]), -imag(tw[k2*16])))
		work[base+17] = mathpkg.MulComplex64(r17, complex(real(tw[k2*17]), -imag(tw[k2*17])))
		work[base+18] = mathpkg.MulComplex64(r18, complex(real(tw[k2*18]), -imag(tw[k2*18])))
		work[base+19] = mathpkg.MulComplex64(r19, complex(real(tw[k2*19]), -imag(tw[k2*19])))
		work[base+20] = mathpkg.MulComplex64(r20, complex(real(tw[k2*20]), -imag(tw[k2*20])))
		work[base+21] = mathpkg.MulComplex64(r21, complex(real(tw[k2*21]), -imag(tw[k2*21])))
		work[base+22] = mathpkg.MulComplex64(r22, complex(real(tw[k2*22]), -imag(tw[k2*22])))
		work[base+23] = mathpkg.MulComplex64(r23, complex(real(tw[k2*23]), -imag(tw[k2*23])))
		work[base+24] = mathpkg.MulComplex64(r24, complex(real(tw[k2*24]), -imag(tw[k2*24])))
		work[base+25] = mathpkg.MulComplex64(r25, complex(real(tw[k2*25]), -imag(tw[k2*25])))
		work[base+26] = mathpkg.MulComplex64(r26, complex(real(tw[k2*26]), -imag(tw[k2*26])))
		work[base+27] = mathpkg.MulComplex64(r27, complex(real(tw[k2*27]), -imag(tw[k2*27])))
		work[base+28] = mathpkg.MulComplex64(r28, complex(real(tw[k2*28]), -imag(tw[k2*28])))
		work[base+29] = mathpkg.MulComplex64(r29, complex(real(tw[k2*29]), -imag(tw[k2*29])))
		work[base+30] = mathpkg.MulComplex64(r30, complex(real(tw[k2*30]), -imag(tw[k2*30])))
