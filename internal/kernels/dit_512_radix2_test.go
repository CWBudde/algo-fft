...
func TestForwardDIT512Complex64(t *testing.T) {
	...
	if !forwardDIT512Complex64(dst, src, twiddle, scratch) {
...
func TestInverseDIT512Complex64(t *testing.T) {
	...
	if !forwardDIT512Complex64(fwd, src, twiddle, scratch) {
		t.Fatal("forwardDIT512Complex64 failed")
	}

	if !inverseDIT512Complex64(dst, fwd, twiddle, scratch) {
...
func TestForwardDIT512Complex128(t *testing.T) {
	...
	if !forwardDIT512Complex128(dst, src, twiddle, scratch) {
...
func TestInverseDIT512Complex128(t *testing.T) {
	...
	if !forwardDIT512Complex128(fwd, src, twiddle, scratch) {
		t.Fatal("forwardDIT512Complex128 failed")
	}

	if !inverseDIT512Complex128(dst, fwd, twiddle, scratch) {
...
// TestRoundTripDIT512Complex64 tests forward then inverse returns original.
func TestRoundTripDIT512Complex64(t *testing.T) {
	t.Parallel()
	...
	assertComplex64Close(t, dst, src, size512Tol64)
}

// TestRoundTripDIT512Complex128 tests forward then inverse returns original (complex128).
func TestRoundTripDIT512Complex128(t *testing.T) {
	t.Parallel()
	...
	assertComplex128Close(t, dst, src, size512Tol128)
}
