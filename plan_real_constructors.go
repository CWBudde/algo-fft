...
// This is one-line sugar for NewPlanReal[float32, complex64](n).
//
// The forward transform accepts float32 input and produces complex64 output.
func NewPlanReal32(n int) (*PlanReal[float32, complex64], error) {
	return NewPlanReal[float32, complex64](n)
}

// NewPlanReal32WithOptions creates a new single-precision real FFT plan with planner options.
func NewPlanReal32WithOptions(n int, opts PlanOptions) (*PlanReal[float32, complex64], error) {
	return NewPlanRealWithOptions[float32, complex64](n, opts)
}

// NewPlanReal64 creates a new double-precision (float64) real FFT plan.
// This is one-line sugar for NewPlanReal[float64, complex128](n).
//
...
func NewPlanReal64(n int) (*PlanReal[float64, complex128], error) {
	return NewPlanReal[float64, complex128](n)
}

// NewPlanReal64WithOptions creates a new double-precision real FFT plan with planner options.
func NewPlanReal64WithOptions(n int, opts PlanOptions) (*PlanReal[float64, complex128], error) {
	return NewPlanRealWithOptions[float64, complex128](n, opts)
}
